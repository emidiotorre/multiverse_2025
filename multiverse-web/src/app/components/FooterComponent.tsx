...
function FooterComponent({ footer }: Props) {
  ...
  return (
    <>
      <footer className={`absolute h-max bottom-16 md:bottom-0 top-auto flex-1 w-full max-w-full  flex align-bottom font-Sharp_Grotesk_Book20 md:text-xs ${pathname?.split('/').includes('play')?"bg-black text-white":"bg-white"} `}>
